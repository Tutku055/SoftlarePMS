...
namespace SoftPMS.Persistence.Migrations
{
    ...
    [Migration("20260813081038_AddSystemSettingsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftPMS.Domain.Entities.CalendarNote", b =>
                {
                    ...
                    b.HasIndex("NoteDate", "UserId")
                        .HasDatabaseName("IX_CalendarNotes_NoteDate_UserId");

                    b.ToTable("CalendarNotes", (string)null);
                });

            modelBuilder.Entity("SoftPMS.Domain.Entities.CalendarSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("BirthdayReminderDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);

                    b.Property<int>("CompanyTimezoneOffsetMinutes")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HolidayReminderDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);

                    b.Property<bool>("SendEmailForBirthdays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("SendEmailForHolidays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("SoftPMS.Domain.Entities.EventReminderTracker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EventReminderTrackers", (string)null);
                });
            ...
            modelBuilder.Entity("SoftPMS.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EmployeeNoPrefix")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<int>("GoLiveYear")
                        .HasColumnType("int");
