...
public class CalculateHourlySalaryCommandHandler : IRequestHandler<CalculateHourlySalaryCommand, Guid>
{
    private readonly IApplicationDbContext _context;

    public CalculateHourlySalaryCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }
